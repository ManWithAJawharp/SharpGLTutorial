...
void Model::Draw(const glm::mat4& projection_matrix, const glm::mat4& view_matrix, const glm::vec3& viewPosition, const unsigned int& lightmapTexture, const glm::mat4& lightMatrix, const float& time)
{
	...
	glUniform1i(glGetUniformLocation(program, "lightmapSampler"), 1);
